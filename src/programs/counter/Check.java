...
public class Check {
    ...
    public void validate (String [] data){
        ...
        if (flag == false){
            throw new DataEntryErrorException(sb.toString());
        } 
    }
    ...
    private boolean isValidName (String name){
        for (int i = 0; i < name.length(); i++) {
            if (! Character.UnicodeBlock.of(name.charAt(i)).equals(Character.UnicodeBlock.CYRILLIC)) {
                throw new DataEntryErrorException(String.format("Убедитесь в правильности ввода имени"));
            }
        }
        return true;
    }
    ...
    private boolean isValidDate (String birthday)  {
        ...
        try {
            ...
            throw new DataEntryErrorException("Убедитесь в правильности ввода формата даты");
        }
        ...
        if ((Arrays.asList(month_30).contains(date.getMonthValue()) && day > 30) ||
            ...
            throw new DataEntryErrorException("Убедитесь в правильности ввода даты рождения");
